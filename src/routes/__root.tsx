  ...
  head: () => ({
    meta: [
      ...
      { title: "Gestão de Sistemas | Clínica CEU" },
      {
        name: "description",
        content:
          "Sistema de gestão da Clínica CEU: escala semanal, estoque com validade e enfermagem.",
      },
      { name: "author", content: "Clínica CEU" },
      { property: "og:title", content: "Gestão de Sistemas | Clínica CEU" },
      {
        property: "og:description",
        content: "Escala semanal, estoque FEFO e enfermagem da Clínica CEU.",
      },
